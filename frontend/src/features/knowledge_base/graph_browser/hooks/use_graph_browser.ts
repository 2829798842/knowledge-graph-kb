...
export function use_graph_browser() {
  ...
  return {
    ...
    graph_controls_open: workspace.graph_controls_open,
    graph_inspector_open: workspace.graph_inspector_open,
    active_graph_drawer: workspace.active_graph_drawer,
    graph_viewport_mode: workspace.graph_viewport_mode,
    ...
    set_graph_controls_open: workspace.set_graph_controls_open,
    set_graph_inspector_open: workspace.set_graph_inspector_open,
    set_active_graph_drawer: workspace.set_active_graph_drawer,
    set_graph_viewport_mode: workspace.set_graph_viewport_mode,
