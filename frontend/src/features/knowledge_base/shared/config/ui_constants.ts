...
import type { ImportMode, ModelProvider, QueryMode, WorkspaceTab } from '../types/knowledge_base_types';
...
export const WORKSPACE_TABS = [
  {
    id: 'import',
    label: '导入中心',
    description: '上传文件、粘贴文本，或导入结构化数据。',
  },
  {
    id: 'config',
    label: '模型配置',
    description: '设置提供商、模型、Base URL 和 API Key。',
  },
  {
    id: 'graph',
    label: '图谱浏览',
    description: '查看节点关系、筛选来源，并维护手动关系。',
  },
  {
    id: 'query',
    label: '检索工作台',
    description: '执行问答、表格记录、实体、关系与来源检索。',
  },
  {
    id: 'source',
    label: '来源浏览',
    description: '回看原始来源、元数据和段落证据。',
  },
...
export const MODEL_PROVIDER_OPTIONS: Array<{
...
}> = [
  {
    id: 'openai',
    label: 'OpenAI',
    description: '官方接口，适合直接连接 OpenAI 服务。',
    base_url: 'https://api.openai.com/v1',
  },
  {
    id: 'openrouter',
    label: 'OpenRouter',
    description: '聚合多模型服务，适合统一接入不同模型提供商。',
    base_url: 'https://openrouter.ai/api/v1',
  },
  {
    id: 'siliconflow',
    label: 'SiliconFlow',
    description: '兼容 OpenAI 风格接口，适合国内线路接入。',
    base_url: 'https://api.siliconflow.cn/v1',
  },
  {
    id: 'custom',
    label: '自定义',
    description: '手动填写你自己的兼容接口地址。',
    base_url: '',
  },
];
...
export const QUERY_MODE_OPTIONS: Array<{
...
}> = [
  {
    id: 'answer',
    label: '问答',
    description: '直接提问，并返回自然语言答案与引用证据。',
    examples: ['项目 Alpha 是什么？', '总结一下合规来源的重点。'],
  },
  {
    id: 'record',
    label: '表格记录',
    description: '按关键词检索表格行记录，并查看行级上下文。',
    examples: ['customer_id C001', '订单号 O-1024', '华东 2026-03'],
  },
  {
    id: 'entity',
    label: '实体检索',
  ...
  },
  {
    id: 'relation',
    label: '关系检索',
    description: '检索实体之间的关系模式与上下文。',
    examples: ['依赖', '汇报给', '由谁负责'],
  },
  {
    id: 'source',
    label: '来源检索',
    description: '按来源名称、摘要或来源类型检索。',
...
export const IMPORT_MODES: Array<{ id: ImportMode; label: string; description: string }> = [
  ...
  { id: 'scan', label: '扫描目录', description: '按根目录和匹配模式批量扫描文件。' },
  { id: 'openie', label: 'OpenIE / JSON', description: '导入 OpenIE 结构化实体与关系 JSON。' },
  { id: 'convert', label: '转换结果', description: '导入转换后的结构化数据 JSON。' },
];
